...
function combineIntoConfiguration(configuration, overrides, cypress, implicitIntegrationFolder) {
    ...
    const defaultStepDefinitions = DEFAULT_STEP_DEFINITIONS.map((pattern) => pattern.replace("[integration-directory]", (0, paths_1.ensureIsRelative)(cypress.projectRoot, "integrationFolder" in cypress
        ? cypress.integrationFolder
        : implicitIntegrationFolder)));
    const stepDefinitions = (_b = (_a = overrides.stepDefinitions) !== null && _a !== void 0 ? _a : configuration.stepDefinitions) !== null && _b !== void 0 ? _b : defaultStepDefinitions;
    const json = {
        enabled: (_e = (_c = overrides.jsonEnabled) !== null && _c !== void 0 ? _c : (_d = configuration.json) === null || _d === void 0 ? void 0 : _d.enabled) !== null && _e !== void 0 ? _e : false,
        output: (_f = overrides.jsonOutput) !== null && _f !== void 0 ? _f : (((_g = configuration.json) === null || _g === void 0 ? void 0 : _g.output) || "cucumber-report.json"),
    };
    const html = {
        enabled: (_k = (_h = overrides.htmlEnabled) !== null && _h !== void 0 ? _h : (_j = configuration.html) === null || _j === void 0 ? void 0 : _j.enabled) !== null && _k !== void 0 ? _k : false,
        output: (_l = overrides.htmlOutput) !== null && _l !== void 0 ? _l : (((_m = configuration.html) === null || _m === void 0 ? void 0 : _m.output) || "cucumber-report.html"),
    };
    const messages = {
        enabled: json.enabled ||
            html.enabled ||
            ((_q = (_o = overrides.messagesEnabled) !== null && _o !== void 0 ? _o : (_p = configuration.messages) === null || _p === void 0 ? void 0 : _p.enabled) !== null && _q !== void 0 ? _q : false),
        output: (_r = overrides.messagesOutput) !== null && _r !== void 0 ? _r : (((_s = configuration.messages) === null || _s === void 0 ? void 0 : _s.output) || "cucumber-messages.ndjson"),
    };
    const filterSpecs = (_u = (_t = overrides.filterSpecs) !== null && _t !== void 0 ? _t : configuration.filterSpecs) !== null && _u !== void 0 ? _u : false;
    const omitFiltered = (_w = (_v = overrides.omitFiltered) !== null && _v !== void 0 ? _v : configuration.omitFiltered) !== null && _w !== void 0 ? _w : false;
    return {
        stepDefinitions,
        messages,
        json,
...
async function resolve(cypressConfig, environment, implicitIntegrationFolder, configurationFileResolver = cosmiconfigResolver) {
    ...
    if (result) {
        ...
        explicitConfiguration = Object.assign({}, ...Object.entries(result).map((entry) => validateUserConfigurationEntry(...entry)));
